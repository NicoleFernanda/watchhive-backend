"""add new movie data to new media table part3

Revision ID: c55eafcd4a42
Revises: f7c23f3d2fed
Create Date: 2025-09-15 20:33:03.403680
...
revision: str = 'c55eafcd4a42'
down_revision: Union[str, Sequence[str], None] = 'f7c23f3d2fed'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


CSV_PATH = Path(__file__).parent.parent / "data" / "movies_data_part3.csv"
